...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-8 text-center bg-transparent">
            <!-- novo layout banner - display horizontal - single.php -->
...
<div class="single-grid-wrap">
    ...
    <main class="main-post-content">
        ...
        <!-- Banner CTA -->
        <div class="banner-cta-home" style="background:linear-gradient(100deg,#7f00ff 60%,#00bfff 98%); color:#fff; border-radius: 20px; box-shadow: 0 4px 22px #00bfff23, 0 2px 6px #7f00ff21; display:flex; align-items:center; gap:1.05em; font-size:1.13em; font-family: 'Orbitron', Arial, sans-serif; padding:1.18em 1em; margin-bottom:2.1em;justify-content:center;">
            <span style="font-size:1.44em;">🚀</span>
            <span>
                <b>Leve sua produtividade ao nível IA com a Redatudo!</b>
                <br>Conteúdo, design, ebooks, automação para seu negócio.
            </span>
            <a class="cta-link" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>?login_app=chat" style="background:#101022;color:#00ffd0;font-size:1.1em;padding:.8em 2em;margin-left:1.1em;border-radius:13px;text-decoration:none;">Conheça a plataforma</a>
        </div>
        ...
        <div class="ad-banner" id="ad-central">
            <!-- nova layout - diaplay horizontal 01 -->
            <ins class="adsbygoogle"
                style="display:block"
                data-ad-client="ca-pub-9848635946946970"
                data-ad-slot="6452681524"
                data-ad-format="auto"
                data-full-width-responsive="true"></ins>
            <script>
                (adsbygoogle = window.adsbygoogle || []).push({});
        ...
        <div class="ad-inline" id="ad-inline-1">
            <!-- novo layout - in feed - imagem em cima -->
            <ins class="adsbygoogle"
                style="display:block"
        ...
        <div class="ad-inline" id="ad-inline-2" style="margin-bottom:0;">
            <!-- novo layout - multiplex horizontal 01 -->
            <ins class="adsbygoogle"
                style="display:block"
                data-ad-format="autorelaxed"
                data-ad-client="ca-pub-9848635946946970"
                data-ad-slot="1955033313"></ins>
            <script>
                (adsbygoogle = window.adsbygoogle || []).push({});
            </script>
        </div>
