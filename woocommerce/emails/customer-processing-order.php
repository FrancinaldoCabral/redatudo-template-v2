<?php
/**
 * Customer processing order email - Redatudo custom
 * Copie para seu-tema/woocommerce/emails/customer-processing-order.php
 */
...
<p>
  Recebemos seu pedido <strong>#<?php echo $order->get_order_number(); ?></strong> no <strong>Redatudo</strong>!<br>
  Assim que o pagamento for confirmado, seus créditos e/ou acesso ao plano serão liberados automaticamente.
</p>
...
<p>
  Você pode acompanhar sua compra, reenviar comprovante ou atualizar seus dados acessando:<br>
