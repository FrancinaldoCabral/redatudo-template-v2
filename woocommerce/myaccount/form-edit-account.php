...
<div class="row justify-content-lg-center">
    <div class="col-12 col-lg-8">
        ...
        <h2><?php _e( 'Modificar senha', 'woocommerce' ); ?></h2>

        <fieldset class="form-group">
            <label for="password_current"><?php _e( 'Senha atual (deixe em branco para NÃO modificar)', 'woocommerce' ); ?></label>
            <input type="password" class="form-control" name="password_current" id="password_current" />
        </fieldset>
        <fieldset class="form-group">
            <label for="password_1"><?php _e( 'Nova senha (deixe em branco para NÃO modificar)', 'woocommerce' ); ?></label>
            <input type="password" class="form-control" name="password_1" id="password_1" />
        </fieldset>
        <fieldset class="form-group">
            <label for="password_2"><?php _e( 'Confirme a nova senha', 'woocommerce' ); ?></label>
        ...
        <fieldset class="form-group">
            ...
            <input type="submit" class="btn btn-primary mt-3" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>" />
